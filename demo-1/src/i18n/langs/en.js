const en = {
  ...
  "home": {
    "text-0": "Data",
    "text-1": "Total Settled{text}",
    "text-2": "Today's Settlement{text}",
    "text-3": "Remaining Quota{text}",
    "text-4": "Personal Investment{text}",
    "text-5": "Details",
    "text-6": "Yesterday's Earnings",
    "text-7": "Total Earnings",
    "text-8": "My Level",
    "text-9": "Total Team Performance",
    "text-10": "Sub-Team Performance",
    "text-11": "Team Info",
    "text-12": "Level",
    "text-13": "Investment",
    "text-14": "Total Team Performance",
    "text-15": "Sub-Team Performance"
  },
  "itemized": {
    "text-0": "HPC Details",
    "text-1": "All Types",
    ...
    "text-5": "Reset",
    "text-6": "Confirm",
    "text-7": "Select Earnings Type"
  },
  "transactionType0": "All",
  "transactionType1": "Daily Yield",
  "transactionType2": "Direct Referral Reward",
  "transactionType3": "Performance Bonus",
  "transactionType4": "Peer Performance Bonus",
  "transactionType8": "",
  "transactionType9": "",
  "transactionType10": "",
  "transactionType11": "",
