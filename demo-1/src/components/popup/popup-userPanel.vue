...
<template>
  <van-popup v-model:show="visible" round position="top" class="popup-info"
    ...
    <div class="p-15 flex max-w-[375px] mx-auto">
      <div class="w-[154px] bg-[#fff] mr-10 rounded-[20px] pt-24 px-10 pb-20">
        ...
        <div
            class="bg-[#f1faff] py-16 px-15 rounded-[100px] mt-20 mb-18  text-12 font-500 flex items-center justify-center">
      ...
      <div class="flex-1 border border-solid border-[#F7F7F7] pt-10 pl-16 pr-12 rounded-[20px]">
        ...
        <div class="grid grid-cols-2 gap-[10px]">
          <div v-for="item in actions" @click="onSelect(item)"
               ...
               :class="{'text-[#1C3B5E] rounded-[50px] bg-[#56e8ff]':item.code===language}"
          >
            {{ item.text }}
          </div>
        </div>
