...
<!--        <div class="bg-[#F1FAFF] rounded-md   border border-solid border-[#000] p-15">-->
<!--          <div class="flex items-center justify-between ">-->
<!--            <div class="text-16 ">{{ $t('exchange.text1') }}</div>-->
<!--            <div class="text-secondary1-color" @click="doAllFun">{{ $t('exchange.text3') }}</div>-->
<!--          </div>-->
<!--          <div class="flex items-center justify-between my-15">-->
<!--            <div class="flex items-center">-->
<!--&lt;!&ndash;              <Image :src="formInfo.fromCoinIcon" class="token-icon" alt="" round/>&ndash;&gt;-->
<!--              &lt;!&ndash;            <img class="w-[36px] h-[36px] mr-10" :src="formInfo?.fromCoinIcon" alt="">&ndash;&gt;-->
<!--&lt;!&ndash;              <div class="font-bold">{{ upperCase(formInfo?.from_coin) }}</div>&ndash;&gt;-->
<!--            </div>-->
<!--            <van-cell-group :border="false" class="mb-[5px]">-->
<!--              <van-field v-model="num" type="text" placeholder="0.00"></van-field>-->
<!--            </van-cell-group>-->
<!--            &lt;!&ndash;            <div class="text-[#999] text-24 font-bold">&ndash;&gt;-->

<!--            &lt;!&ndash;            </div>&ndash;&gt;-->
<!--          </div>-->
<!--          <div class="flex items-center text-secondary-color mb-5">-->
<!--            <div class="mr-5">{{ $t('exchange.text4') }}:</div>-->
<!--&lt;!&ndash;            <div>{{ fixNumber(formInfo.fromCoinBalance, formInfo.fromCoinPricePlace) }}{{&ndash;&gt;-->
<!--&lt;!&ndash;                upperCase(formInfo?.from_coin)&ndash;&gt;-->
<!--&lt;!&ndash;              }}&ndash;&gt;-->
<!--&lt;!&ndash;            </div>&ndash;&gt;-->
<!--          </div>-->
<!--        </div>-->
<!--        <img @click="changeTradeType" :class="['w-[40px] mx-auto mt-[-10px]', isRotating ? rotateClass : '']"-->
<!--             src="@/assets/image/icon/icon-exchange.png" alt="">-->
<!--        <div class="bg-color-secondary rounded-4 p-15 mt-[-10px] mb-25">-->
<!--          <div class="text-16 ">{{ $t('exchange.text2') }}</div>-->
<!--          <div class="flex items-center justify-between my-15">-->
<!--            <div class="flex items-center">-->
<!--&lt;!&ndash;              <Image :src="toInfo.fromCoinIcon" class="token-icon" :alt="toInfo.from_coin" round/>&ndash;&gt;-->
<!--&lt;!&ndash;              <div class="font-bold">{{ upperCase(toInfo?.from_coin) }}</div>&ndash;&gt;-->
<!--            </div>-->
<!--            <van-cell-group :border="false" class="mb-[5px]">-->
<!--              <van-field v-model="exchangeSum" readonly type="text" placeholder="0.00"></van-field>-->
<!--            </van-cell-group>-->
<!--          </div>-->
<!--          <div class="flex items-center text-secondary-color justify-between ">-->
<!--&lt;!&ndash;            <div class=" rounded-21 px-10 py-3 bg-[#F9F9F9]">&ndash;&gt;-->
<!--&lt;!&ndash;              1{{ upperCase(formInfo?.from_coin) }}≈{{ unitPrice }}{{ upperCase(toInfo?.from_coin) }}&ndash;&gt;-->
<!--&lt;!&ndash;            </div>&ndash;&gt;-->
<!--&lt;!&ndash;            <div class=" rounded-21 px-10 py-3 bg-[#F9F9F9]">&ndash;&gt;-->
<!--&lt;!&ndash;              {{ $t('exchange.text5') }}{{ fixNumber(freeUsdt) }}%&ndash;&gt;-->
<!--&lt;!&ndash;            </div>&ndash;&gt;-->
<!--          </div>-->
<!--        </div>-->
